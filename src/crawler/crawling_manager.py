...
class CrawlingManager:
    ...
    def __init__(self, category: str, url: str):
        ...
        try:
            self.driver = webdriver.Chrome(
                options=options,
                service=Service(executable_path=str(FilePath.CHROME_DRIVER)),
            )
            ...
            self.driver = webdriver.Chrome(
                executable_path=str(FilePath.CHROME_DRIVER), options=options
            )
    ...
    def _driver_wait_and_find(
        self, element: WebElement, by: By, value: str
    ) -> WebElement:
        self._driver_wait(by, value)
        return element.find_element(by, value)

    def _driver_wait_and_finds(
        self, element: WebElement, by: By, value: str
    ) -> list[WebElement]:
        self._driver_wait(by, value)
